...
import assignOffset from '../../src/core/assignOffset'
  ...
  */
  describe('non-overlapping ranges', () => {
    ...
    test('assigns empty arrays to all ranges', () => {
      const results = assignOffset(items)

      expect(results['a'].offset).toEqual(0)
      expect(results['b'].offset).toEqual(0)
      expect(results['c'].offset).toEqual(0)
    })
  })
  ...
  */
  describe('all ranges overlapping', () => {
    ...
    test('assigns context correctly', () => {
      ...
      expect(results['a'].offset).toEqual(0)
      expect(results['b'].offset).toEqual(1 / 3)
      expect(results['c'].offset).toEqual(2 / 3)
    })
  })
  ...
  */
  describe('two independent ranges overlapped by a third', () => {
    ...
    test('assigns context correctly', () => {
      ...
      expect(results['a'].offset).toEqual(0)
      expect(results['b'].offset).toEqual(0)
      expect(results['c'].offset).toEqual(1 / 2)
    })
  })
  ...
  */
  describe('two independent clusters', () => {
    ...
    test('assigns context correctly', () => {
      ...
      expect(results['b'].offset).toEqual(0)
      expect(results['c'].offset).toEqual(1 / 2)
      expect(results['d'].offset).toEqual(0)
    })
  })
  ...
  */
  describe('one convoluted cluster', () => {
    ...
    test('assigns context correctly', () => {
      ...
      expect(results['a'].offset).toEqual(0)
      expect(results['b'].offset).toEqual(0)
      expect(results['c'].offset).toEqual(1 / 3)
      expect(results['d'].offset).toEqual(2 / 3)
      expect(results['e'].offset).toEqual(1 / 3)
    })
  })
})
